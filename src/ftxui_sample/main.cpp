...
// configuration step. It creates a namespace called `gefilte_framework`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", gefilte_framework::cmake::project_name, gefilte_framework::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", gefilte_framework::cmake::project_version);
      return EXIT_SUCCESS;
    }
